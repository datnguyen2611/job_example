              ...
              success: function (res) {
                  ...
                  $.each(res, function(index, value) {
                      tableRow =
                          ...
                          '                           <div class="form-button">' +
                          '                               <a href="'+'url('+'admin'+value.id+'edit'+')'+'" class="btn btn-primary button-fix">Chỉnh Sửa</a>' +
                          '                               <form action="'+'url('+'admin/'+value.id+')'+'" class="delete-method" method="POST">' +
                          '                                   {'+'{'+'csrf_field()'+'}'+'}' +
                          '                                   {'+'{'+'method_field('+'DELETE'+')}'+'}' +
                          '                                   <input type="submit" name="submit"class="btn btn-primary button-fix delete-form" onclick="return confirm(\'Are you sure?\')"  value="xóa">' +
                          '                               </form>' +
                          ...
                          '                           <h5 class="card-title name">Giới tính: '+value.gender ==0 ?"Nam" :"Nữ"+'</h5>' +
